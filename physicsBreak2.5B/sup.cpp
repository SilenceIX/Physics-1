...
QVBoxLayout *sRect5 ()
{
    ...
    addLabel(Lay, "«Система состоит из двух физических маятников, расположенных на расстоянии l от точек подвеса, связанных между собой невесомой пружиной с коэффициентом жесткости k. "
                  ...
                  "углами ?1 и ?2 отклонения маятников от вертикали, т.е. система имеет две степени свободы.");
    ...
    addLabel(Lay, "Такие колебания называются нормальными модами колебаний (или нормальными колебаниями) системы связанных осцилляторов, а частоты ?_1и ?_2 – нормальными частотами."
